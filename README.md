...
Once the `conda-forge` channel has been enabled, `nr.types` can be installed with:

```
conda install nr.types
```

It is possible to list all of the versions of `nr.types` available on your platform with:
